...
public class AsyncTaskEnviarClave extends AsyncTask<String, Void, String[]> {
    private ProgressDialog progressDialog;
    private Context context;
    private AsyncTaskEnviarClave.AsyncResponse binder = null;
    ...
    public AsyncTaskEnviarClave(Context context, AsyncResponse asyncResponse) {
    ...
    protected String[] doInBackground(String... params) {
        ...
        String service = AppConstants.WebServs.REENVIAR_CLAVE;
