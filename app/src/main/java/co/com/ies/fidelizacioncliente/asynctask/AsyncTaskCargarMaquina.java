...
import co.com.ies.fidelizacioncliente.entity.CargarMaquinaBody;
...
/**
 * Permite cargar la maquina
 *
 * Created by juddy on 03/04/2018.
 */
public class AsyncTaskCargarMaquina extends AsyncTask<String, Void, String[]> {
    private ProgressDialog progressDialog;
    private Context context;
    private AsyncTaskCargarMaquina.AsyncResponse binder = null;
    ...
    public AsyncTaskCargarMaquina (Context context, AsyncResponse asyncResponse) {
    ...
    protected String[] doInBackground(String... params) {
        ...
        String service = AppConstants.WebServs.CARGAR_MAQUINA;
        ...
        try {
            ...
            //Parametros Body
            CargarMaquinaBody body=new CargarMaquinaBody(preferences.getString(AppConstants.Prefs.SERV_USR, ""),
                    preferences.getString(AppConstants.Prefs.SERIAL, ""),
                    preferences.getString(AppConstants.Prefs.ID_CASINO, ""), valor, AppConstants.WebCons.CARGAR_CANJEABLE);
